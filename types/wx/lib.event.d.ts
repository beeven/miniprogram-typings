...
declare namespace event {
     ...
     */
    type InputConfirm = event.Custom<{
        value: string
    }>
     ...
     */
    type InputKeyboardHeightChange = event.Custom<{
        height: number
        duration: number
    }>
}
